...
<!--<![endif]-->
      ...
      <div class="wrapper" id="wrapper">
        <header>
          ...
          <div class="bannerText container">
            <h1>I'm Coy</h1>
            <h2>I Design &amp; Build Crafted Web Experiences</h2>
          </div>
          <!--menu start-->
          <div class="menu">
            ...
            <div class="container">
              ...
              <div class="row">
                <div class=" col-xs-12 col-sm-12 col-md-7 col-lg-7">
                  ...
                  <a href="files/coy_resume.pdf" class="bntDownload">Download Printable Resume</a> </div>
                  <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 col-md-offset-1 col-lg-offset-1 proPic"> <img src="photos/coy.jpg" alt="" class="img-circle topmar"> </div>
                </div>
              </div>
            </section>
            <!--about me end-->
                ...
                <div class="row">
                  ...
                  <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
                    <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="95"> <span class="percent"></span> </span>
                      <h4>PHP</h4>
                      <p>Making websites dynamic since 1995.</p>
                    </div>
                  </div>
                  <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
                  ...
                  <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
                    <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="80"> <span class="percent"></span> </span>
                      <h4>Objective-C</h4>
                      <p>Used to make native iPhone/iPad apps.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row workDetails">
                  ...
                  <section class="education" id="education">
                    <div class="container">
                      ...
                      <div class="row workDetails">
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                          <div class="workYear">December, 2009</div>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                          <div class="arrowpart"></div>
                          <div class="exCon">
                            <h4>BS in Management and Organizational Development</h4>
                            <h5>University of Mount Olive</h5>
                            <p>Organization development is a deliberately planned, organization-wide effort to increase an organization's effectiveness and/or efficiency and/or to enable the organization to achieve its strategic goals.</p>
                          </div>
                        </div>
                      </div>
                      <div class="row workDetails">
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                          <div class="workYear">June, 2010</div>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                          <div class="arrowpart"></div>
                          <div class="exCon">
                            <h4>AS in Web Technologies</h4>
                            <h5>Pitt County Community College</h5>
                            <p>Focused on web standards and programming and development theory.</p>
                          </div>
                        </div>
                      </div>
                      <div class="row workDetails">
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                          <div class="workYear">Present</div>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                          <div class="arrowpart"></div>
                          <div class="exCon">
                            <h4>Masters Degree in Software Engineering</h4>
                            <h5>East Carolina University</h5>
                            <p>As my best fiend would say, I'm studying to become a master. I'm pursuing this degree to hone my development abilities and apply them to future projects.</p>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  <section class="contactDetails">
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
        ...
        <p> <i class="fa fa-envelope-o "></i> <a href="mailto:coylums@gmail.com">coylums@gmail.com</a></p>
        <p> <i class="fa fa-link "></i> <a href="coylums.com">coylums.com</a></p>
      </div>
      <!--contact info end-->
  ...
  <section class="footer" id="footer">
    <div class="container">
      <ul>
        <li><a href="https://twitter.com/coylums"><i class="fa fa-twitter fa-2x"></i></a></li>
        <li><a href="https://www.facebook.com/coylums"><i class="fa fa-facebook fa-2x"></i></a></li>
        <li><a href="http://www.linkedin.com/pub/coy-woolard/14/350/22a"><i class="fa fa-linkedin fa-2x"></i></a></li>
        <li><a href="http://www.pinterest.com/coylums/"><i class="fa fa-pinterest fa-2x"></i></a></li>
      </ul>
    </div>
  </section>
